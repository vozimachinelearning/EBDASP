...
if not defined SWARM_PUBLIC_SEEDS set "SWARM_PUBLIC_SEEDS="
set "SWARM_GROUP_ID=public"
set "SWARM_NETWORK=1"
set "SWARM_NODE_ID=%COMPUTERNAME%"
set "SWARM_LLM_ID=%SWARM_LLM_REPO:/=--%"
set "SWARM_LLM_BASE=%SWARM_MODELS%\llm"
set "SWARM_LLM_PATH=%SWARM_LLM_BASE%\%SWARM_LLM_ID%"
set "SWARM_EMBED_PATH=%SWARM_MODELS%\embeddings"
if not defined SWARM_MODEL_PATH set "SWARM_MODEL_PATH=%SWARM_LLM_PATH%"
if not defined SWARM_EMBEDDING_PATH set "SWARM_EMBEDDING_PATH=%SWARM_EMBED_PATH%"
